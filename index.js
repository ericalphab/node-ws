...
const UUID = process.env.UUID || 'a3e6117f-bfa3-499a-828a-6290356820ee'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'a3e6117f-bfa3-499a-828a-6290356820ee';            // 获取节点的订阅路径
